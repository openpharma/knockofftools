...
This function uses the randomForestSRC package to estimate importance
...
- y:
  ...
  be a survival object of class "Surv" (type="survival") as obtained
  from y = survival::Surv(time, status).
