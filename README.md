<!-- badges: start -->
[![R-CMD-check](https://github.com/openpharma/knockofftools/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/openpharma/knockofftools/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
